...
# 图片路径存放位置
# =========================================================
IMAGE_PATH = r"E:\Windows_Desktop\work1\2.jpg"
# =========================================================
...
def main():
    ...
    if image is None:
        ...
        return
    centers = detect_black_line(image)
    direction = judge_line(centers)
    red_points = detect_red_circle(image)
    # ---------------------------------------------------------
    # 在图片上标记红色圆点
    # ---------------------------------------------------------
